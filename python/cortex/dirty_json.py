"""
python/cortex/dirty_json.py — Lenient JSON Parser
===================================================
Exact copy of python/helpers/dirty_json.py.
CORTEX owns this module; it has zero external dependencies.

Handles malformed LLM JSON output:
    ...
    def _skip_whitespace(self):
        while self.current_char is not None:
            if self.current_char.isspace():
                self._advance()
            elif self.current_char == "/" and self._peek(1) == "/":
