"""
python/cortex/tool.py — Tool Base Class + Response
====================================================
CORTEX-owned copy of python/helpers/tool.py.

Same API as AZ original. CORTEX tools import from here after H1-B.
before_execution / after_execution still use AZ's PrintStyle and agent.context.log
during H1 transition — replaced with CortexLogger in H1-C.
"""
